...
(function( $, window, undefined ) {
	...
	$.extend( $.mobile, {
		...
		resetActivePageHeight: function( height ) {
			...
			//Dharmendra Gupta Coding
			$("#contentHolder,#contentHolder1,#contentHolder2,#contentHolder3,#contentHolder4,#contentHolder5,#contentHolder6,#contentHolder7,#contentHolder8,#contentHolder9,#contentHolder10,#contentHolder11,#contentHolder12,#contentHolder13").css("height", (height - ( pageOuterHeight - pageHeight )+parseFloat( page.css( "padding-top" ))+parseFloat( page.css( "padding-bottom"))));
             //alert($("html").height());
             //$("html, body").css( "height", (height+parseFloat(page.css( "padding-top" ))+parseFloat( page.css( "padding-bottom"))));
			//alert(height);
             // Add width for penal view
             //$(body).css('width',page.width());
             //alert($("html").height());
	//alert("total= "+height+" height margian="+parseFloat( pageOuterHeight - pageHeight )+" total final="+(height - parseFloat( pageOuterHeight - pageHeight )+parseFloat(parseFloat( page.css( "padding-top" ))+parseFloat( page.css( "padding-bottom")))));
	//	alert(parseFloat( page.css( "padding-bottom")));
